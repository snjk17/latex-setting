...
3. **AI執筆支援の利用 (任意)**: 
   - **GitHub Copilot**: VS Code標準のAI支援を利用したい場合に設定します。
   - **Antigravity**: AIプラン（プロプラン）に加入している場合、追加設定なしでAI生成機能が利用可能です。
   - 好みに合わせていずれか（または両方）を選択して活用してください。
